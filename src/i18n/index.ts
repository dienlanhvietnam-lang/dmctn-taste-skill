...
const en: Dict = {
  ...
  'overview.statusTitle': 'Project status',
  'overview.actionsTitle': 'Quick actions',
  'overview.pillLocal': 'Local only',
  'overview.pillSkills': '15 skills',
  'overview.pillTelemetry': 'No telemetry',
  'overview.pillBilingual': 'VI / EN',
  ...
  'presets.marketplace': 'Marketplace Listing Page',
  ...
  'presets.marketplace.desc': 'Marketplace listing for extensions/apps — screenshots, install CTA, developer trust.',
  ...
  'prompts.outputTitle': 'Generated prompt',
...
const vi: Dict = {
  ...
  'overview.statusTitle': 'Trạng thái dự án',
  'overview.actionsTitle': 'Thao tác nhanh',
  'overview.pillLocal': 'Chỉ chạy cục bộ',
  'overview.pillSkills': '15 skill',
  'overview.pillTelemetry': 'Không telemetry',
  'overview.pillBilingual': 'Việt / Anh',
  ...
  'install.modeMinimal': 'Minimal',
  'install.modeFull': 'Full',
  'install.recommended': 'Khuyên dùng',
  'install.modeCustom': 'Custom',
  ...
  'presets.marketplace': 'Trang giới thiệu Marketplace',
  ...
  'presets.marketplace.desc': 'Trang listing extension/app trên Marketplace — screenshot, CTA cài, tin cậy developer.',
  ...
  'prompts.outputTitle': 'Prompt đã tạo',
